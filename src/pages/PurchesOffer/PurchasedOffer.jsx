...
const PurchasedOffer = () => {
 ...
 const fetchData = async () => {
  ...
  await axios
    .post(`${ServerUrl}/getAllPurchasedUser`, data, {
      headers: authHeader(),
    })
    .then((res) => {
...
const fetchTotalData = async () => {
  await axios
    .get(`${ServerUrl}/getPurchasedUserCount
    `, {
      headers: authHeader(),
    })
    .then((res) => {
...
const hanldeGetdata = async (spinrentaloffers_id) => {
  ...
  axios
    .get(`${ServerUrl}/getSpinRentalUserById?spinrentaloffers_id=${spinrentaloffers_id}`, {
      headers: authHeader(),
    })
    .then((res) => {
      if (res.data.data) {
...
const QuotesStatus = async (e) => {
  ...
  axios
    ...
    .then((res) => {
      ...
      toast.success(' Purchased offer  successfully');
      setTimeout(() => {
        window.location.reload();
      }, 2000);
    })
  ...
  return (
    <>
        ...
        Purchased Offer <br />
            ...
            {/* {Lenght} */}
            <div className="tolal_user"> {Lenght} -Purchased Offer</div>
          </div>
          <div className="dummy">
        ...
        <div className="purches_data">
          ...
          <div className="Dashbord_tabldiv  tavlcolor">
            <ul className="dashbord_list" onClick={() => hanldeGetdata(item.spinrentaloffers_id)}>
